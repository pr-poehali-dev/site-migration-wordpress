...
const services = [
  ...
  { icon: "Shovel", title: "Откопать автомобиль", desc: "В зимнее время откапываем машину из снега — быстро, приедем в течение часа", price: "от 500 ₽" },
  ...
  { icon: "Flame", title: "Отогрев автомобиля", desc: "Отогреем замёрзший двигатель, замки и топливную систему — в зимнее время, выезд до 60 минут", price: "от 700 ₽" },
];
