      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
            ...
            <Link to="/news" className="text-[#0055b3] font-semibold hover:text-[#ff6600] transition-colors">Новости</Link>
        ...
        {menuOpen && (
          <div className="md:hidden pb-4 border-t border-gray-100 animate-fade-in">
            <nav className="flex flex-col gap-3 pt-4">
              ...
              <Link to="/news" className="text-[#0055b3] font-semibold py-1 hover:text-[#ff6600] transition-colors" onClick={() => setMenuOpen(false)}>
                Новости
              </Link>
