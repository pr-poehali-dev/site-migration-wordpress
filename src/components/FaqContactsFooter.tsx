...
const faq = [
  ...
  { q: "Есть ли зимние услуги — откопать и прикурить автомобиль?", a: "Да, в зимнее время мы оказываем услуги по откапыванию автомобиля из снега и прикуриванию севшего аккумулятора. Выезжаем быстро — в течение 30–60 минут. Звоните в любое время суток!" },
];
